...
import 'package:cr_app/features/login/presentation/views/login_screen.dart';
...
class CrLoginScreen extends StatelessWidget {
  CrLoginScreen({super.key});
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text("CR Login only!", style: context.tt.bodySmall),
                  ...
                  // OTHER LOGIN PLATFORM
                  GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => LoginScreen()));
                      },
                      child: Text("Student Login", style: TextStyle(fontSize: 16.spMin, color: UColors.primary, fontWeight: FontWeight.w900, decoration: TextDecoration.underline, decorationColor: UColors.primary),)),
                  20.verticalSpace,
